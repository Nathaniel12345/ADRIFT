...
public class Bullet
{
    ...
    public Bullet( float x, float y, double rotate )
    {
        a = new Animation();
        try
        {
    ...
    public Rectangle getBounds()
    {
        ...
        return r;
        //Shape ar = txBounds.createTransformedShape(r);
        //System.out.println(((Area)ar).getBounds());
        //Area area = (Area)ar;
        //return area;
    }
    ...
    public void render(Graphics2D g)
    {
        ...
        //Area tempar = new Area();
        //ar = tempar.createTransformedArea(tx);
        //ar.transform(tx);
        txBounds = tx;
